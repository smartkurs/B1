...
var qstHead;
var groups;
var quizTitle="B1 saison 4";
var printCpRg=1;
var filename = 'b1 saison 4';
...
function initShortQuestion() {
 qstHead[0]="Übung 1  Werbung im Fernsehen Lesen Sie die Ergebnisse einer Umfrage.     ";
 qstHead[1]=" Lesen und hören Sie den folgenden Text.         1 Ordnen Sie die im Text u...";
 qstHead[2]="  Ergänzen Sie die Superlative.  ";
 qstHead[3]=" Ergänzen Sie die Sätze wie im Beispiel. Achten Sie auf den Satzbau.   Beis...";
 qstHead[4]="  Stellen Sie Fragen und beantworten Sie sie in ganzen Sätzen (im Komparati...";
 qstHead[5]=" Wie heißen die passenden Adjektive? Achten Sie darauf, ob ein bestimmter o...";
 qstHead[6]="  Bilden Sie Adjektive wie im Beispiel. Überlegen Sie, ob Partizip I oder I...";
 qstHead[7]="  Lesen Sie die folgenden Werbeanzeigen    1 Fragen zu den Anzeigen. Was is...";
 qstHead[8]="1 Fragen zu den Anzeigen. Was ist richtig? Kreuzen Sie an.   c. Was ist neu...";
 qstHead[9]="  Ergänzen Sie die passenden Adjektive aus den Werbeanzeigen  erstklassige ...";
 qstHead[10]=" Ergänzen Sie die Adjektive in den Werbetexten  Achten Sie darauf, ob ein b...";
 qstHead[11]="Übung 4  Hören Sie das folgende Gespräch im Fachgeschäft und beantworten Si...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4,4,4,4,4,1,1,4,4,4);
