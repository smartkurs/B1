...
var qstHead;
var groups;
var quizTitle="B1 saison 6";
var printCpRg=1;
var filename = 'B1 saison 6';
...
function initShortQuestion() {
 qstHead[0]="Hören Sie eine Radiosendung zum Thema: Argerim StmRenverkehr.  Was ist rich...";
 qstHead[1]="Lesen und hören Sie den folgenden Text           Welche Aussage ist richtig?";
 qstHead[2]="Was passt? Ordnen Sie die Verben zu.  lesen  beseitigen  nachholen einreich...";
 qstHead[3]="Wie heißt die passende Proposition? Wählen Sie aus.  ";
 qstHead[4]="Sie horen vier kurze Texte.  Markieren Sie beim Horen oder danach, ob die A...";
 qstHead[5]="Lesen und hören Sie den Text.          Ergänzen Sie die Verben in der richt...";
 qstHead[6]="Was war vorher passiert? Ergänzen Sie die Satze im Plusquamperfekt.    Beis...";
 qstHead[7]="Gleichzeitigkeit I Verbinden Sie die Satze mit wenn oder als.  Beispiel  Ic...";
 qstHead[8]="Dauer Erganzen Sie bis oder seit seitdem.   Beispiel  Ich warte,  bist du k...";
 qstHead[9]="Mem Handy ist weg! Bilden Sie die Fragen im Perfekt wie im Beispiel.   Beis...";
 qstHead[10]="Die Gegenstande sind auch am falschen Ort.  Benutzen Sie   rein runter rauf...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(2,4,4,4,2,4,4,4,4,4,4);
