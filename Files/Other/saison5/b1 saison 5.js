...
var qstHead;
var groups;
var quizTitle="B1 saison 5";
var printCpRg=1;
var filename = 'b1 saison 5';
...
function initShortQuestion() {
 qstHead[0]="Was ist richtig, was ist falsch? Kreuzen Sie an  ";
 qstHead[1]="Bilden Sie Sätze mit sonst oder andernfalls.   Beispiel  1. Sie sollten Ihr...";
 qstHead[2]="Schreiben Sie Finalsatze.  Benutzen Sie um ...zu oder damit.  Beispiel  1. ...";
 qstHead[3]="Lebenslanges Lernen  Horen Sie ein Gesprach zum Thema: Lebenslanges Lernen....";
 qstHead[4]="Erganzen Sie die Nomen.  Verantwortung   Studium   Arbeitsmarkt   Chancen  ...";
 qstHead[5]="Sagen Sie es formeller. Verwenden Sie dazu Nomen-Verb-Verbindungen.    Beis...";
 qstHead[6]="Ergänzen Sie die fehlenden Nomen in der richtigen Form.  Steigerung   Einfl...";
 qstHead[7]="Formen Sie die Sätze um wie im Beispiel.  Man muss die Worter wiederholen, ...";
 qstHead[8]="Formulieren Sie Sätze mit damit oder um ... zu   Beispiel  Paolo lernt Deut...";
 qstHead[9]="Erganzen Sie die richtigen Verbformen.  ausüben  leisten  üben  treffen  ve...";
 qstHead[10]="Ergänzen Sie  dieselbe denselben dieselben demselben";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(2,4,4,2,4,4,4,4,4,4,4);
