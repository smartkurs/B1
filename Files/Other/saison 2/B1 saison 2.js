...
var qstHead;
var groups;
var quizTitle="B1 Saison 2 ";
var printCpRg=1;
var filename = 'B1 saison 2';
...
function initShortQuestion() {
 qstHead[0]="Übung 1 Machen Sie ein Audio:  Geben Sie einen Rat.  Beispiel:  Frau Krause...";
 qstHead[1]="Übung 2  Machen Sie ein Audio.  Machen Sie Vorschläge und wählen Sie einen ...";
 qstHead[2]="Übung 3  Hören Sie die folgenden Telephongespräche. Ergänzen Sie die fehlen...";
 qstHead[3]="Übung 4  Telefonieren Ordnen Sie zu.   Beispiel  Ich melde mich am Telefon ...";
 qstHead[4]="E-mail Terminabsage  Sie haben einen Termin am 20. Mai um 10 Uhr mit einem ...";
 qstHead[5]="E-Mail Terminabsage Was passt?  ";
 qstHead[6]="Wörter und Wendungen mit Infinitv mit zu.  Folgende Wörter und Wendungen we...";
 qstHead[7]="Übersetzen Sie.  Anbieten Empfehlen Empfinden Gelten Hinterlassen Leihen Me...";
 qstHead[8]="Ergänzen Sie im Telefongespräch die fehlende Verben in der richtigen Form. ...";
 qstHead[9]="Formulieren Sie Empfehlungen wie im Beispiel.  Beispiel  die folgenden Hinw...";
 qstHead[10]="Lesen Sie di folgenden Sätze. Analysieren Sie. In welchem Kasus steht Herr?...";
 qstHead[11]="Ergänzen Sie.  Herr Kollege Kunde  Beispiel  Das ist ein Brief für Herrn Sc...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(3,3,4,4,3,4,4,3,4,4,4,4);
