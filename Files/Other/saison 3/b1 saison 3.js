...
var qstHead;
var groups;
var quizTitle="B1 saison 3";
var printCpRg=1;
var filename = 'b1 saison 3';
...
function initShortQuestion() {
 qstHead[0]="Übung 1  Lesen und hören Sie den folgenden Text      Ordnen Sie zu  1 Welch...";
 qstHead[1]="Übung 2  Was kann man mit Büchern machen?  Suchen Sie die Verben aus dem Text.";
 qstHead[2]="Übung 3  Welches Nomen passt? ";
 qstHead[3]="Übung 4          A.Worum geht es in den Büchern? Ergänzen Sie die Sätze.  ";
 qstHead[4]="Übung 5  Bilden Sie Infinitivkonstruktionen.  Formen Sie die kursiv gedruck...";
 qstHead[5]="Übung 6  Ergänzen Sie die Verben im Passiv Präteritum.   Beispiel. Der Buch...";
 qstHead[6]="Übung 7  Formulieren Sie Sätze in der angegebenen Zeitform.  Beispiel. der ...";
 qstHead[7]="  Hören Sie und lesen Sie den folgenden Text        Was bedeuten diese Zahl...";
 qstHead[8]="Hören Sie eine Radiosendung zum Thema Fernsehen Was ist richtig, was ist fa...";
 qstHead[9]="  Lesen Sie un hören Sie den folgenden Text      1 Ergänzen Sie. An welche ...";
 qstHead[10]=" Ergänzen Sie die fehlenden Verben in der richtigen Form.  wissen  denken  ...";
 qstHead[11]=" Hätten wir nur alles anders gemacht!  Bilden Sie Sätze mit dem Konjunktiv ...";
 qstHead[12]=" Irreale Bedingungen. Wenn ich das gewusst hätte 1 Bilden Sie Sätze mit dem...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4,4,4,4,4,4,2,4,4,4,4);
